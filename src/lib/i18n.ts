...
const tr = {
  ...
  arsa: {
    ...
    fillAll: "Lütfen ad, soyad, telefon ile il, ilçe, mahalle, ada ve parsel bilgilerini eksiksiz girin.",
...
const en: Dict = {
  ...
  arsa: {
    ...
    fillAll: "Please enter your name, surname and phone, then select province, district, neighborhood and enter block/parcel numbers.",
...
const ar: Dict = {
  ...
  arsa: {
    ...
    fillAll: "يرجى إدخال الاسم واللقب ورقم الهاتف، ثم اختيار المحافظة والمنطقة والحي وإدخال رقم القطعة والبارسيل.",
