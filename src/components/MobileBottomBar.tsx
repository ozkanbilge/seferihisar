...
export function MobileBottomBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-ink/85 backdrop-blur-xl border-t border-ink-line px-2 min-[380px]:px-4 pb-[env(safe-area-inset-bottom)]">
      ...
      <div className="flex items-stretch justify-between h-16 max-w-lg mx-auto">
        {/* Ana Sayfa */}
        <Link
          href="/"
        ...
        >
          ...
          <span className="text-[0.55rem] min-[380px]:text-[0.62rem] font-semibold tracking-wide min-[380px]:tracking-wider uppercase whitespace-nowrap">Ana Sayfa</span>
        </Link>
        ...
        >
          ...
          <span className="text-[0.55rem] min-[380px]:text-[0.62rem] font-semibold tracking-wide min-[380px]:tracking-wider uppercase whitespace-nowrap">Satılık</span>
        </Link>
        ...
        >
          <div className="absolute -top-4 w-11 h-11 min-[380px]:w-12 min-[380px]:h-12 rounded-full bg-gradient-to-tr from-gold-deep to-gold-bright flex items-center justify-center shadow-lg border-2 border-ink shadow-gold/20 active:scale-95 transition-transform">
          ...
          <span className="text-[0.55rem] min-[380px]:text-[0.62rem] font-semibold tracking-wide min-[380px]:tracking-wider uppercase whitespace-nowrap mt-8">Arsa Sorgu</span>
        </Link>
        ...
        >
          ...
          <span className="text-[0.55rem] min-[380px]:text-[0.62rem] font-semibold tracking-wide min-[380px]:tracking-wider uppercase whitespace-nowrap">Kiralık</span>
        </Link>
        ...
        >
          ...
          <span className="text-[0.55rem] min-[380px]:text-[0.62rem] font-semibold tracking-wide min-[380px]:tracking-wider uppercase whitespace-nowrap">Destek</span>
